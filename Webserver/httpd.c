...
void httpd_header_check (unsigned char index)
{
	 ...
	 * Wenn OUT=B wird der Pin gesetzt (PortAPin1), ansonsten gelšscht
	 */
...
{	
	...
	for (a = 0;a<(MTU_SIZE-(TCP_DATA_START)-150);a++)
	{
		...
		if (b == '%')
		{
			...
			{	
				/*
				 * Kryptische Berechnug der BalkenlŠngen auf basis der Werte der AD-Wandler -> mŸssen wir kapieren
				 */
            ...
            /*
             * Hier werden die Checboxes fŸr das Formular gesetzet (durch einfŸgen von "checked")
             */
